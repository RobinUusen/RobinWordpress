...
$core_taxonomy = new \Falang\Core\Taxonomy($falang_id,$this->model);
        ...
        <div class="col-title">
            ...
            <?php foreach ($falang_taxonomy_fields as $field ) { ?>
                <div class="row">
                    ...
                    <div class="col-target">
		                <?php if ($field == 'description') { ?>
                            <textarea name="<?php echo $field; ?>" id="<?php echo $field; ?>"  cols="22" rows="4"><?php echo $previous_value;?></textarea>
		                <?php } else { ?>
