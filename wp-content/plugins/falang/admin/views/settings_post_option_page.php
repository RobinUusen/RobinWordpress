			...
			<?php if ($falang_post_type !== 'post' && $falang_post_type !== 'page' && $falang_post_type !== 'attachment' && $falang_post_type_obj->publicly_queryable) { ?>
				...
				<tr>
					...
					<td>
						...
						<p class="description"><?php echo sprintf(__('Permalink base slug is originally: %s. It is overwrited by Falang.'), '<code>'.$falang_post_type_obj->rewrite['slug'].'</code>'); ?></p>
					</td>
				</tr>
				<?php if ($falang_post_type_obj->has_archive && $falang_post_type_obj->has_archive !== true) { ?>
					<tr>
						...
						<td>
							...
							<p class="description"><?php echo sprintf(__('Archive slug is originally: %s. It is overwrited by Falang.'), '<code>'.$falang_post_type_obj->has_archive.'</code>'); ?></p>
						</td>
					</tr>
				<?php } ?>
			<?php } ?>
