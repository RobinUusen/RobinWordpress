...
//
		...
		do_action( 'falang_before_post_translations', $post_type );
			//todo put this in 1 line
			//display language link translation if a local not exist
		    if (empty($locale)) {
			    echo '<div id="meta-post-translations" class="translations" >';
		    } else {
			    echo '<div id="meta-post-translations" class="translations" style="display:none" >';
		    }
